...
CLightFitnessFunction::CLightFitnessFunction(const char* pch_name, 
...
double CLightFitnessFunction::GetFitness()
{    
...
/******************************************************************************/
/******************************************************************************/
void CLightFitnessFunction::SimulationStep(unsigned int n_simulation_step, double f_time, double f_step_interval)
{
