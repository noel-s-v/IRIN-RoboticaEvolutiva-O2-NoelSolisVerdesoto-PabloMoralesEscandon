...
// /*25x16 arena without PIT and with extra barriers*/
// "%%%%%%%%%%%%%%%%%%%%%%%%%"
// "%%%%%%%%%%%%%%%%%%%%%%%%%"
// "%%%%%#####%%%%%#####%%%%%"
// "%%%%#######%%%#######%%%%"
...
// /*25x25 arena without PIT and with extra barriers*/
// "%%%%%%%%%%%%%%%%%%%%%%%%%"
// "%%%%%%%%#########%%%%%%%%"
// "%%%%%###############%%%%%"
// "%%%%#################%%%%"
...
// /*25x25 arena with PIT stop and added barriers*/
// "%%%%%%%%%%%%%%%%%%%%%%%%%"
// "%%%%%%%%%%%%%%%%%%%%%%%%%"
// "%%%%%#####%%%%%#####%%%%%"
// "%%%%#######%%%#######%%%%"
...
CCTRNNExp::~CCTRNNExp ( void )
{
	...
	/******************************************************************************/
/******************************************************************************/
CArena* CCTRNNExp::CreateArena()
{
	/* Create Arena */
	CArena* pcArena = NULL;
	/*Uncomment for 20x20 maps*/
	// pcArena = new CProgrammedArena("CProgrammedArena", 20, 20, 3.0, 3.0);

	/*Uncomment for 25x16 maps*/
	// pcArena = new CProgrammedArena("CProgrammedArena", 25, 16, 3.75, 2.4);

	/*Uncomment for 25x25 maps*/
	pcArena = new CProgrammedArena("CProgrammedArena", 25, 25, 3.75, 3.75);
...
void CCTRNNExp::AddActuators(CEpuck* pc_epuck)
{
...
void CCTRNNExp::AddSensors(CEpuck* pc_epuck)
{
	//
...
void CCTRNNExp::SetController(CEpuck* pc_epuck)
{
	char pchTemp[128];
